...
public static class RecognizerServiceExtensions
{
    ...
    /// <param name="callback"></param>
    /// <returns></returns>
    public static async Task RecognizeOnceAsync(this IRecognizerProvider provider, Func<string, Task> callback)
    {
        var option = new RecognizerOption()
        {
            MethodName = "bb_azure_speech_recognizeOnce",
    ...
    /// <param name="callback"></param>
    /// <returns></returns>
    public static async Task CloseAsync(this IRecognizerProvider provider, Func<string, Task> callback)
    {
        var option = new RecognizerOption()
        {
            MethodName = "bb_azure_close_recognizer",
